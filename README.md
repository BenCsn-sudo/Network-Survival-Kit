...
![Focus](https://img.shields.io/badge/Focus-Network%20%26%20Security-green)
...
* ✍️ **Vulgarisation :** Reformuler les concepts complexes (Modèle OSI, TCP/IP).
...
| Chapitre | Sujet | État | Concepts clés |
| :--- | :--- | :---: | :--- |
| **01** | **Introduction aux Réseaux** | 🔄 | LAN/WAN, Topologies, Commutation |
| **02** | **Modèles d'Architecture** | ⏳ | OSI (7 couches), TCP/IP |
| **03** | **Couche Physique & Liaison** | ⏳ | Ethernet, MAC, Trames |
| **04** | **Couche Réseau (IP)** | ⏳ | IPv4/IPv6, Subnetting, Routing |
...
```text
.
├── 01-intro-reseaux/       # Définitions et base
